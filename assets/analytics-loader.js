...
styles.innerHTML = `
    ...
    .ax-header-left {
        ...
        letter-spacing: 2px; text-shadow: 0 0 8px rgba(255, 255, 255, 0.6); pointer-events: auto;
    }
    .ax-header-right { display: flex; gap: 8px; pointer-events: auto; }
    .ax-stat-box {
        background: rgba(10, 10, 10, 0.75) !important; backdrop-filter: blur(5px); -webkit-backdrop-filter: blur(5px);
    ...
    .ax-stat-box.online .stat-value { color: #00ffcc !important; text-shadow: 0 0 6px rgba(0, 255, 204, 0.6); }
